  ...
  return (
    <section className='py-12 lg:py-24 '>
       <div className='container mx-auto'>
          <h2 className='text-3xl font-bold mb-6' data-aos='fade-down' data-offset='300'>Mixed Reality Headsets</h2>
          <div className='grid gap-y-4 lg:grid-cols-2 lg:gap-9'>
           <div className='relative' data-aos='zoom-in' data-offset='300' data-delay='1000'>
           ...
           <div className='relative'  data-aos='zoom-in' data-offset='300' data-delay='1300'>
           ...
           <div className='relative'  data-aos='zoom-in' data-offset='300' data-delay='1600'>
           ...
           <div className='relative' data-aos='zoom-in' data-offset='300' data-delay='1900'>
