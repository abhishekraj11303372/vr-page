  ...
  return (
    <nav className='lg:hidden bg-[#251f3f] w-full h-full'>
      ...
      <ul className='flex flex-col items-center justify-center space-y-8 h-full font-secondary'>
        <li className='text-lg'><a className='nav-link' href='#'>Home</a></li>
        <li className='text-lg'><a className='nav-link' href='#'>Company</a></li>
        <li className='text-lg'><a className='nav-link' href='#'>Features</a></li>
